 ...
 * @author Aidem
 */
public class PrinterResource implements Serializable {
    ...
    private PrinterResource(){

    }

    private PrinterResource(Builder builder)
    {
    ...
    public static class Builder {
        ...
        public Builder PrinterResource (PrinterResource chassis)
        {
        ...
        public PrinterResource build() {
            return new PrinterResource(this);
        }
