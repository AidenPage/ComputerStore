 ...
 */
public class MainboardResource implements Serializable {
    ...
    private MainboardResource(){

    }

    private MainboardResource(Builder builder)
    {
    ...
    public static class Builder {
        ...
        public Builder MainboardResource (MainboardResource chassis)
        {
        ...
        public MainboardResource build() {
            return new MainboardResource(this);
        }
