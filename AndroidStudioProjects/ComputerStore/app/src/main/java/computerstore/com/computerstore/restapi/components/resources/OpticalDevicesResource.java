 ...
 * @author Aidem
 */
public class OpticalDevicesResource implements Serializable {
    ...
    private OpticalDevicesResource(){

    }

    private OpticalDevicesResource(Builder builder)
    {
    ...
    public static class Builder {
        ...
        public Builder OpticalDevicesResource (OpticalDevicesResource chassis)
        {
        ...
        public OpticalDevicesResource build() {
            return new OpticalDevicesResource(this);
        }
