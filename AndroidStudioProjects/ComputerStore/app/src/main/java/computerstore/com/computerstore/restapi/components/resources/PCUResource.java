...
public class PCUResource implements Serializable {
    ...
    private PCUResource(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder PCUResource(PCUResource chassis) {
        ...
        public PCUResource build() {
            return new PCUResource(this);
        }
