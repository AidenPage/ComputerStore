...
public class NotebookResource implements Serializable{
    ...
    private NotebookResource(Builder builder)
    {
    ...
    public static class Builder {
        ...
        public Builder NotebookResource (NotebookResource chassis)
        {
        ...
        public NotebookResource build() {
            return new NotebookResource(this);
        }
