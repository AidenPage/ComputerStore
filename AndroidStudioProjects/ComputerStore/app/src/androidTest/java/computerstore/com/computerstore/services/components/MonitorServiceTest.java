...
import computerstore.com.computerstore.services.components.Impl.MonitorServiceImpl;

public class MonitorServiceTest extends AndroidTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        Intent intent = new Intent(App.getAppContext(), MonitorServiceImpl.class);
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            MonitorServiceImpl.MonitorServiceLocalBinder binder
                    = (MonitorServiceImpl.MonitorServiceLocalBinder) service;
    ...
    public void testUpdateMonitor() throws Exception {
        Monitor monitor = new Monitor.Builder()
                ...
                .price(2000.00)
                .build();
        Monitor chas = monitorService.updateMonitor(monitor);
